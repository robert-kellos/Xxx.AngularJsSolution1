...
namespace Repository.Pattern.Ef6
{
    ...
    public abstract class FakeDbContext : IFakeDbContext
    {
        ...
        public void SyncObjectState<TEntity>(TEntity entity) where TEntity : class, IEntity<long>
        {
            // no implementation needed, unit tests which uses FakeDbContext since there is no actual database for unit tests, 
