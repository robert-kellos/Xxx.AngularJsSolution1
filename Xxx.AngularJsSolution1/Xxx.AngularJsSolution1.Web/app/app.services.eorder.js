(function () {
    'use strict';
    angular.module('app')
    .factory('eordersService', ['_', '$http', 'ngUrlSettings', eordersService]);

    function eordersService(_, $http, ngUrlSettings) {

        var serviceBase = ngUrlSettings.apiResourceServer
        var endPointUrl = serviceBase + 'api/eorders/activeOrders';
        var exports = {};
