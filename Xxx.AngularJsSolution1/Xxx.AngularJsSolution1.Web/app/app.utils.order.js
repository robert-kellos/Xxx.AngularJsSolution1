(function () {
    'use strict';
    angular.module('app')
    .factory('orderUtils', ['_', '$mdDialog', '$state', 'toastr', orderUtils]);

    function orderUtils(_, $mdDialog, $state, toastr) {

        var exports = {};

        var _takeSessionSnapshot = function (order) {
            exports.workingOrder = order;
            exports.masterOrder = angular.copy(order);
        }
        ...
        var _saveOrder = function () {
            ...
            toastr.success('Order Saved successfully', 'Save Changes');
        }

        var _redirectToOrderRoute = function () {
            var routeName = 'createorder';
